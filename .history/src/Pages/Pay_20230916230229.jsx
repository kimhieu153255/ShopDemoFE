          ...
          BuyList.map((item, ind) => (
            ...
            >
              <span className="w-3/5 text-lg flex items-center">
                ...
                <span className="pl-2 line-clamp-1 w-40">{item.name}</span>
                <div>
                  <span className="pl-2 inline-block">Color: {item.color}</span>
                  <span className="pl-2 inline-block">Size: {item.size}</span>
                </div>
              </span>
