    ...
    <div className=" w-full xl:w-4/5  mx-auto min-w-max">
      ...
      <div className=" border bg-gray-100 p-5 mt-2">
        <div>
          ...
          <button className="px-3 py-2 border-green-500 border rounded-md font-semibold hover:text-green-500 hover:border-green-500 ml-5">
            Payment on delivery
          </button>
          <button className="px-3 py-2 border-gray-500 border rounded-md font-semibold hover:text-green-500 hover:border-green-500 ml-5">
            Payment by card
          </button>
        </div>
      </div>
