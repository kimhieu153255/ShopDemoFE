          ...
          <div>
            ...
            < className="flex items-center justify-center">
              ...
              <input
                ...
                defaultValue="1"
                readOnly
                className="bg-gray-100 px-2 w-14 text-center border-2 border-gray-300 rounded-md"
              />
              <button className="px-3 py-1 bg-gray-100 border rounded-l-md text-md text-center items-center justify-center hover:bg-green-500 hover:text-white"></button>
