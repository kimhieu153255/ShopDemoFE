    ...
    <div>
      <div className="flex m-4 gap-10 bg-gray-100 rounded-md min-w-max">
        <img
          src="/logoShop.avif"
          alt="bg"
          className="brightness-50 opacity-70 inline-block w-[400px] h-[150px] object-cover rounded-md absolute z-0"
        />
        <div className="flex flex-col p-4  w-[400px] h-[150px] text-white font-semibold z-20 min-w-max">
        ...
        <div className="flex gap-20 flex-shrink-0 p-4 font-semibold w-full">
          <div>
            <div>Products: {}</div>
            <div>Following: {}</div>
          </div>
