...
import { FaCommentAlt, FaPlus, FaShoppingBag } from "react-icons/fa";
  ...
  return (
    <div className="min-w-max">
      <div className="flex m-4 gap-5 bg-gray-100 rounded-md min-w-max shadow-md">
        ...
        <div className="flex justify-around gap-10 text-xl items-center justify-center p-4 font-semibold h-full w-full">
          <div>
            <div>
              <FaShoppingBag className="inline-block"></FaShoppingBag> Products:{" "}
              {}
            </div>
            <div>Following: {}</div>
          </div>
