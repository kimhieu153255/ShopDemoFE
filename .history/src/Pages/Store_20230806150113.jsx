...
const loadDataStore = async (storeId, category, page, sort) => {
  const url = `http://localhost:3001/api/v1/products?storeId=${storeId}&category=${category}&page=${page}&sort=${sort}`;
