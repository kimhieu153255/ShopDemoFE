  ...
  return (
    <div className=" w-full xl:w-4/5 border p-5 mx-auto bg-gray-100">
      <div>
        ...
        <select className="px-2 py-1 border border-gray-300 focus:ring-1 focus:ring-green-500 rounded-md">
            ...
            return (
              <div className="mt-2" key={ind}>
                <label>
                  <input
                    type="radio"
                    name="address" // Use the same name for all radio buttons in the group
                    value={item._id} // Set the value to the unique identifier of the address
                  />
