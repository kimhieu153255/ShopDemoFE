  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (tempImage) {
        ...
        if (imgSrc) setProduct((product) => ({ ...product, imgSrc }));
        console.log("product sau khi có ảnh", product);
      }
  ...
  return (
    <div className="w-full border bg-gray-100 py-2 rounded-md m-auto relative">
      ...
      <button
        ...
        onClick={() => (window.location.headers = `/shop/a/1`)}
      >
        <FaArrowLeft />
      </button>
