      ...
      <div className="relative">
        ...
        {!isHidden && (
          <div className="fixed top-0 left-0 h-screen w-full">
            ...
            <div className="m-auto px-2 py-1 z-20 fixed inset-0 w-[600px] h-[600px] bg-white">
              <div className="text-xl">My Addresses</div>
              {addresses.map((item, ind) => {
                return (
                  <label className="mt-2" key={ind}>
                    <div className="flex items-center gap-3 mt-23">
                      <input
                        type="radio"
                        name="address"
