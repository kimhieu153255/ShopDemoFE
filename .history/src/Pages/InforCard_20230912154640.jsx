    ...
    <div className="mx-auto 2xl:mx-40 ">
      ...
      <div className="flex py-5 bg-gray-50 rounded-sm">
        ...
        <div className="w-full mx-5">
          ...
          <button className="bg-green-500 text-white font-semibold py-2 px-5 rounded-md hover:bg-green-600 mt-5">
            <FaCartPlus className="inline-block my-auto"></FaCartPlus> Add to
            cart
          </button>
          <button className="">
