  ...
  return (
    <div>
      <div className="flex m-4 gap-10 bg-gray-100 rounded-md min-w-max">
        ...
        />
        <div className="w-[400px] h-[150px] relative flex flex-col p-4  text-white font-semibold z-10 ">
        ...
        <div className="flex gap-20 flex-shrink-0 p-4 font-semibold w-full z-10">
          <div>
            <div>Products: {}</div>
            <div>Following: {}</div>
          </div>
