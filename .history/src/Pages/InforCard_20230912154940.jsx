    ...
    <div className="mx-auto 2xl:mx-40 ">
      ...
      <div className="flex py-5 bg-gray-50 rounded-sm">
        ...
        <div className="w-full mx-5">
          ...
          <div className="mt-5">
            <button className="bg-green-500 text-white font-semibold py-2 px-5 rounded-md hover:bg-green-600 flex items-center inline-block gap-3 text-xl">
              <FaCartPlus className="inline-block"></FaCartPlus>
              <div>Add to cart</div>
            </button>
            <button className="bg-green-500 text-white font-semibold py-2 px-5 rounded-md hover:bg-green-600">
              Buy now
            </button>
          </div>
        </div>
