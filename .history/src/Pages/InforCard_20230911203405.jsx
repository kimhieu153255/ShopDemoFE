...
const InforCard = ({ proId }) => {
  proId = "64cfbc1ec16afbd0eee2bb43";
      ...
      <div className="flex py-5 bg-gray-50 rounded-sm">
        ...
        <div className="w-full mx-5">
          ...
          <div className="flex items-center">
            ...
            <span className="text-gray-500 pl-3 border border-l-2 ml-2"></span>
          ...
          <div className="font-semibold text-amber-600 text-3xl p-3 bg-gray-200 my-5 rounded-md">
