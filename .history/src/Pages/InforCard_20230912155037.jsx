      ...
      <div className="flex py-5 bg-gray-50 rounded-sm">
        ...
        <div className="w-full mx-5">
              ...
              <div className="flex gap-2">
                {sizeArr.map((size, index) => (
                  <div
                    ...
                    onClick={() => {
                      if (!sizes.includes(size) || sizeChosen === size) return;
                      setSizeChosen(size);
                      setQuantity(1);
                    }}
                  >
          ...
          <div className="flex gap-10 items-center">
            ...
            <div className="flex">
              <button
                className="px-3 bg-gray-200 border rounded-l-md text-md text-center items-center justify-center hover:bg-green-500 hover:text-white py-1"
                onClick={() => {
                  if (quantity > 1) {
              ...
              />
              <button
                className="px-3 py-1 bg-gray-200 border rounded-r-md text-md text-center items-center justify-center hover:bg-green-500 hover:text-white"
                onClick={() => {
                  if (
                    quantity <
            ...
            <div className="font-semibold">Available: {available}</div>
          ...
          <div className="mt-5 flex gap-5">
            <button className="bg-green-500 text-white font-semibold py-2 px-5 rounded-md hover:bg-green-600 flex items-center gap-3 text-xl">
              <FaCartPlus className="inline-block text-xl"></FaCartPlus>
              <div>Add to cart</div>
            </button>
            <button className="bg-green-500 text-white font-semibold py-2 px-5 rounded-md hover:bg-green-600 text-xl">
              Buy now
            </button>
          </div>
        </div>
