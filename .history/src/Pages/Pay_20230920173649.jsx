  ...
  return (
    <div className=" w-full xl:w-4/5  mx-auto min-w-max">
              ...
              <div className="m-auto py-2 z-20 absolute inset-0 w-[600px] h-[600px] bg-white">
                ...
                {addresses.length > 0 && (
                  ...
                  >
                    ...
                    <button
                      className="px-5 py-2 w-full text-center border-t"
                      onClick={() => navigate("/address")}
                    >
                      Add new address
                    </button>
                    <AddAddress isHidden={true} setIsHidden={}></AddAddress>
                  </div>
                )}
      ...
      <div className=" border bg-gray-100 p-5 mt-2">
        ...
        <div className="w-96 ml-auto py-5 border-b">
        ...
        <div className="flex items-center justify-between pt-5">
          <div>
            <span>Clicking "Place Order" means you agree to abide by </span>
            <a
              href="/term/use"
          ...
          <div className="px-5 py-2 border inline-block rounded-lg bg-green-500 text-white hover:bg-green-600 text-xl font-semibold">
            Order
          </div>
        </div>
      </div>
