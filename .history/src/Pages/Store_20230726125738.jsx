  ...
  return (
    <div>
      <div className="flex m-4 gap-10 bg-gray-100 rounded-md min-w-max">
        ...
        />
        <div className=" flex flex-col p-4  text-white font-semibold z-10 ">
          ...
          <div className="flex gap-2 mt-1 w-[400px]">
            <span className="px-3 py-1 border rounded-md flex justify-center items-center gap-2 cursor-pointer">
              <FaPlus></FaPlus>
              Follow
            </span>
            <span className=" py-1 border rounded-md flex justify-center items-center gap-2 cursor-pointer">
              <FaCommentAlt></FaCommentAlt>
              Chat
            </span>
          </div>
        </div>
        <div className="flex gap-20 p-4 font-semibold h-full w-full">
          <div>
            <div>Products: {}</div>
            <div>Following: {}</div>
          </div>
