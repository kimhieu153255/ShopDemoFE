  ...
  return (
    <div>
      <div className="flex m-4 gap-10 bg-gray-100 rounded-md min-w-max">
        ...
        />
        <div className=" flex flex-col p-3 w-[400px] h-[150px] text-white font-semibold z-10 ">
        ...
        <div className="flex justify-between gap-20 p-4 font-semibold h-full w-full">
          <div>
            <div>Products: {}</div>
            <div>Following: {}</div>
          </div>
