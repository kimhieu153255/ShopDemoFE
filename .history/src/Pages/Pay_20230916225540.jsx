      ...
      <div className=" border bg-gray-100 p-5 mt-2">
        ...
        {BuyList.length > 0 &&
          BuyList.map((item, ind) => (
            <div
              className="flex justify-between font-semibold mt-2 py-1"
              key={ind}
            >
              <span className="w-3/5 text-lg line-clamp-1 flex items-center">
                ...
                <div>
                  <span className="pl-2">Color: {item.color}</span>
                  <span className="pl-2">Size: {item.size}</span>
                </div>
              </span>
