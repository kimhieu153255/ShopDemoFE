  ...
  return (
    <div>
      <div className="flex m-4 gap-10 bg-gray-100 rounded-md min-w-max shadow-md">
        ...
        />
        <div className=" flex flex-col p-3 w-[400px] h-[150px] text-white font-semibold z-10 shadow-md">
          <div className="flex gap-5 justify-start items-start m-1 w-[400px]">
            <img
              src="/avatar.avif"
              alt="logoShop"
          ...
          <div className="grid grid-cols-2 gap-2 mt-1 min-w-max">
            <span className="px-3 py-1 border rounded-md flex justify-center items-center gap-2 cursor-pointer hover:text-green-500">
              <FaPlus></FaPlus>
              Follow
            </span>
