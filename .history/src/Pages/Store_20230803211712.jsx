  ...
  return (
    <div className="min-w-max w-full">
      <div className="flex flex-col">
        ...
        <div className="flex justify-center items-center py-1.5 bg-gray-200 mb-2">
          <button className="py-1 px-2 border border-gray-100 bg-gray-100 rounded-md font-semibold hover:bg-green-500 hover:text-white hover:border-green-500">
            Add
          </button>
        </div>
      </div>
