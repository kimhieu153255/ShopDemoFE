        ...
        <div className="w-full mx-5">
          ...
          <div className="flex gap-10">
            ...
            <div className="flex items-center justify-center">
              <button className="px-3 py-2 bg-gray-200 border rounded-l-md text-md text-center items-center justify-center hover:bg-green-500 hover:text-white h-full">
                <FaMinus />
              </button>
              <input
                type="text"
                ...
                defaultValue="1"
                readOnly
                className="bg-gray-100 w-14 text-center border border-gray-300 py-1.5"
              />
              <button className="px-3 py-2 bg-gray-200 border rounded-r-md text-md text-center items-center justify-center hover:bg-green-500 hover:text-white">
                <FaPlus></FaPlus>
              </button>
            </div>
          </div>
