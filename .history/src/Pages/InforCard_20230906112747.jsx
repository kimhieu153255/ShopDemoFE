        ...
        <div className="w-full mx-5">
          ...
          <div className="flex gap-10">
            ...
            <div className="flex items-center justify-center">
              <button className="px-3 py-1 bg-gray-200 border rounded-l-md text-md text-center items-center justify-center hover:bg-green-500 hover:text-white">
                <FaMinus />
              </button>
              <input
                type="text"
              ...
              />
              <button className="px-3 py-1 bg-gray-1200 border rounded-r-md text-md text-center items-center justify-center hover:bg-green-500 hover:text-white">
                <FaPlus></FaPlus>
              </button>
            </div>
          </div>
