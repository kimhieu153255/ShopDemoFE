      ...
      <div className="relative">
        ...
        {!isHidden && (
          <div className="fixed top-0 left-0 h-screen w-full">
            ...
            <div className="m-auto  py-2 z-20 fixed inset-0 w-[600px] h-[600px] bg-white">
              <div className="text-xl px-5 py-3 font-bold border-b">
                My Addresses
              </div>
              ...
              <div className="flex gap-2 justify-end mr-3 items-end">
                <button className="px-3 py-2 border-red-500 border rounded-md bg-red-500 text-white font-semibold hover:bg-red-600">
                  Cancle
                </button>
                <button className="px-3 py-2 border-green-500 border rounded-md bg-green-500 text-white font-semibold hover:bg-green-600">
                  Save
                </button>
              </div>
            </div>
