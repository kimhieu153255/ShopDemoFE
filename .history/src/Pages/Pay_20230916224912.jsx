    ...
    <div className=" w-full xl:w-4/5  mx-auto">
      ...
      <div className=" border bg-gray-100 p-5 mt-2">
        <div className="flex justify-between font-semibold">
          <span className="w-3/5 text-lg">Product</span>
          <div className="w-2/5 flex text-center text-gray-500">
        ...
        {BuyList.length > 0 &&
          BuyList.map((item, ind) => (
            <div className="flex justify-between font-semibold mt-2" key={ind}>
              <span className="w-3/5 text-lg">{item.name}</span>
              <div className="w-2/5 flex text-center text-gray-500">
