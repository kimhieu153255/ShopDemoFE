    ...
    <div>
      <div className="flex m-4 gap-10 bg-gray-100 rounded-md min-w-max">
        <img
          src="/logoShop.avif"
          alt="bg"
          className="brightness-50 opacity-70 inline-block w-[400px] h-[150px] object-cover rounded-md absolute min-w-full"
        />
        ...
        <div className="flex gap-20 p-4 font-semibold h-full justify-between">
          <div>
            <div>Products: {}</div>
            <div>Following: {}</div>
          </div>
