    ...
    <div>
      <div className="flex m-4 gap-10 bg-gray-100 rounded-md min-w-max">
        <img
          src="/logoShop.avif"
          alt="bg"
          className="brightness-50 opacity-70 inline-block sm:w-[400px] sm:h-[150px] w-[350px] h-[100px] object-cover rounded-md absolute z-10"
        />
        <div className="flex flex-col p-4  sm:w-[400px] sm:h-[150px] w-[350px] h-[100px] text-white font-semibold z-20">
        ...
        <div className="flex gap-20 flex-shrink-0 p-4 font-semibold">
          <div>
            <div>Products: {}</div>
            <div>Following: {}</div>
          </div>
