  ...
  return (
    <div>
      <div className="flex w-32">
        ...
        {new Array(3).fill(0).map((el, ind) => {
          if (page + ind > totalPage) return null;
          return (
            <button
              key={ind}
              className={
                `px-3 py-2 bg-gray-100 border text-md text-center items-center justify-center hover:bg-green-500 hover:text-white` +
                (page === ind + 1 && ` bg-green-500 text-white`)
              }
              onClick={() => {
                setPage();
              }}
