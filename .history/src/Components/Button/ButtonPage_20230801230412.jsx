  ...
  return (
    <div>
      <div className="flex w-32">
        ...
        <button
          className={`px-3 py-2 bg-gray-100 border rounded-r-md text-md text-center items-center justify-center hover:bg-green-500 hover:text-white` + (count === total && `hidden`)}
          onClick={() => {
