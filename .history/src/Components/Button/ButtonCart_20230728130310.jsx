...
const ButtonCart = ({ id, encreaseQuantity, updateQuantity }) => {
    ...
    <div className="flex w-32">
      <button
        ...
        onClick={() => {
          ...
          if (count > 1 && encreaseQuantity) encreaseQuantity(id, false);
        }}
      >
        <FaMinus />
      </button>
      <input
        ...
        onChange={(e) => {
          ...
          if (e.target.value > 1) {
            ...
            updateQuantity && updateQuantity(id, e.target.value - 1);
          }
        }}
      ></input>
      <button
