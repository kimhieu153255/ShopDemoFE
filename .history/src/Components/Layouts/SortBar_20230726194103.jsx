...
const SortBar = () => {
  ...
  return (
    <div className="flex justify-between w-full h-fit items-center bg-gray-200 px-10 rounded-md font-semibold">
      <div className="flex gap-4">
        <span>Sort by:</span>
        <span className="hover:text-green-500 p-2 border">Popularity</span>
        <span className="hover:text-green-500 p-2 border">Lastest</span>
        <span className="hover:text-green-500 p-2 border">Selling</span>
        <div
          onMouseOver={() => {
            setIsDropdown(true);
