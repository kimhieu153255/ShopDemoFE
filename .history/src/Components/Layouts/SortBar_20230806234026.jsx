      ...
      <div className="flex gap-4">
        ...
        <span
          ...
          onClick={(e) => {
            ...
            // }${page ? `page=${page}&` : ""}sort=soldCount`;
            navigate(
              `/shop?${category ? `category=${category}&` : ""}${
                page ? `page=${page}&` : ""
              }sort=soldCount`
            );
            //vì sao phải dùng navigate thay cho window.location.href
            //vì navigate sẽ không reload lại trang
            //còn window.location.href thì sẽ reload lại trang
            //và khi reload lại trang thì useEffect sẽ chạy lại
            //và khi useEffect chạy lại thì nó sẽ gọi lại api
            //và khi gọi lại api thì nó sẽ gọi lại api ở trang 1
            //và khi gọi lại api ở trang 1 thì nó sẽ trả về trang 1
          }}
        >
          Popularity
        </span>
            ...
            >
              <span
                ...
                onClick={() => {
                  ...
                  window.location.href = `/shop?${
                    category ? `category=${category}&` : ""
                  }${page ? `page=${page}&` : ""}sort=Low-to-high`;
                }}
              >
              ...
              <span
                ...
                onClick={() => {
                  ...
                  window.location.href = `/shop?${
                    category ? `category=${category}&` : ""
                  }${page ? `page=${page}&` : ""}sort=High-to-low`;
                }}
              >
