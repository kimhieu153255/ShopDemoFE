  ...
  return (
    <>
      <div className="shadow-md mb-2">
        ...
        <div className="mb-2 pb-4 px-3.5">
          <form
          ...
          >
            ...
            />
            <button className="p-1 rounded-md px-2 border focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent bg-green-500 text-white -translate-x-[6.8rem] hover:bg-green-600">
              Search
            </button>
          </form>
        </div>
