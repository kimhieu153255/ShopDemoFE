  ...
  return (
    <div className="flex justify-between w-full h-fit items-center bg-gray-200 px-10 rounded-md font-semibold py-2 min-w-max gap-5">
      <div className="flex gap-4">
        ...
        >
          <div
            className="flex items-center gap-2 hover:bg-green-500 hover:text-white border bg-gray-100 rounded-md p-1 cursor-pointer"
            className={state === "Price" ? "bg-green-500 text-white" : ""}
          >
            <span>Price</span>
            <div ref={caretRef}>
          ...
          {isDropdown && (
            ...
            >
              <span
                ...
                onClick={() => setState("Popularity") && SortByPrice(true)}
              >
              ...
              <span
                className="hover:text-green-500 cursor-pointer"
                onClick={() => setState("Popularity") && SortByPrice(false)}
              >
