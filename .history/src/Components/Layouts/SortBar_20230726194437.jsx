  ...
  return (
    <div className="flex justify-between w-full h-fit items-center bg-gray-200 px-10 rounded-md font-semibold py-2">
      <div className="flex gap-4">
        ...
        <span className="hover:text-green-500 p-1 border bg-gray-100 rounded-md">
          Popularity
        </span>
        <span className="hover:text-green-500 p-1 border bg-gray-100 rounded-md">
          Lastest
        ...
        >
          <div className="flex items-center gap-2 hover:text-green-500 border bg-gray-100 rounded-md p-1">
            <span>Price</span>
            <div ref={caretRef}>
