...
const Footer = () => {
  return (
    <div className="bg-gray-100 pt-10 pb-5 flex justify-around">
      <div className="flex flex-col text-lg w-28 min-w-max ">
        ...
        {ArrShop.map((item, index) => (
          <span
            key={index}
            className="py-1 cursor-pointer hover:scale-110 hover:text-green-600 pl-1 hover:font-semibold"
          >
            {item.title}
          </span>
        ))}
      </div>
      <div className="flex flex-col text-lg w-32  min-w-max">
