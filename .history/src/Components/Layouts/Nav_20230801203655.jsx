    ...
    <>
      <div className="shadow-md mb-2 px-[10%]">
        ...
        <div className="mb-2 pb-4 flex">
          ...
          <div
            className="ml-auto text-5xl text-green-500 self-center hover:text-green-600 cursor-pointer transition-all text-right relative"
          ...
          >
            ...
            <div className="hidden absolute -translate-x-full" ref={DropRef}>
