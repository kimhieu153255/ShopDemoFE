    ...
    <>
      <div className="shadow-md mb-2 px-[10%]">
        ...
        <div className="mb-2 pb-4 flex">
          ...
          <div
            className="flex flex-col ml-auto text-5xl text-green-500 self-center hover:text-green-600 cursor-pointer transition-all justify-end relative"
          ...
          >
            ...
            <div className="hidden absolute text-right" ref={DropRef}>
