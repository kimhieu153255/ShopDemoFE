      ...
      <div className="flex gap-4">
        ...
        <span
          ...
          onClick={() => {
            setState("Popularity");
            // SortBySold(false);
            window.location.href = `/shop?${category&&({'category'=category})}sort=soldCount`;
          }}
        >
          Popularity
        </span>
        <span
          ...
          onClick={() => {
            ...
            window.location.href = `/shop?sort=latest`;
          }}
        >
          Lastest
        </span>
        <span
          ...
          onClick={() => {
            setState("rate");
            // SortByRate(true);
            window.location.href = `/shop?sort=rate`;
          }}
        >
          top rating
        </span>
            ...
            >
              <span
                ...
                onClick={() => {
                  ...
                  // SortByPrice(true);
                  window.location.href = `/shop?sort=Low-to-high`;
                }}
              >
              ...
              <span
                ...
                onClick={() => {
                  ...
                  // SortByPrice(false);
                  window.location.href = `/shop?sort=High-to-low`;
                }}
              >
