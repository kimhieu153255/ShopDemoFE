...
const ArrFollow = [
  {
    title: "Facebook",
    link: "#",
    icon: <FaFacebook className="inline-block text-5xl"></FaFacebook>,
  },
  {
    title: "Instagram",
    link: "#",
    icon: <FaInstagram className="inline-block text-5xl"></FaInstagram>,
  },
  {
    title: "Twitter",
    link: "#",
    icon: <FaTwitter className="inline-block text-5xl"></FaTwitter>,
  },
  {
    title: "Youtube",
    link: "#",
    icon: <FaYoutube className="inline-block text-5xl"></FaYoutube>,
  },
];
