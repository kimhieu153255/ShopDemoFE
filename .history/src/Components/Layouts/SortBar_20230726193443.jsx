...
const SortBar = () => {
  ...
  return (
    <div className="flex justify-between w-full h-fit items-center bg-gray-200 px-10 rounded-md py-2 font-semibold">
      <div className="flex gap-4">
        ...
        >
          ...
          {isDropdown && (
            <div
              className="absolute px-4 py-2 border rounded-md bg-gray-100 flex flex-col hidden"
              ref={DropRef}
            >
