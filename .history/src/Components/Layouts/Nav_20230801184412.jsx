    ...
    <>
      <div className="shadow-md mb-2 px-[10%]">
        ...
        <div className="mb-2 pb-4 flex">
          ...
          <div
            className="flex items-center justify-center gap-2 ml-auto text-4xl text-green-500 hover:text-green-600 cursor-pointer transition-all"
          ...
          >
            ...
            <div className="hidden absolute translate-x-0" ref={DropRef}>
