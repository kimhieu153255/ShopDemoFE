    ...
    <>
      <div className="shadow-md mb-2 px-[10%]">
        ...
        <div className="mb-2 pb-4 flex">
          ...
          <div
            className="ml-auto text-4xl text-green-500 self-center hover:text-green-600 cursor-pointer transition-all"
          ...
          >
            <FaShoppingCart className="inline-block"></FaShoppingCart>
