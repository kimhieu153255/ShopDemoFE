    ...
    <>
      <div className="shadow-md mb-2 px-[10%]">
        ...
        <div className="mb-2 pb-4 flex">
          ...
          <div
            className="flex justify-end ml-auto text-3xl text-green-500 self-center hover:text-green-600 cursor-pointer transition-all  relative"
            onMouseOver={() => {
          ...
          >
            <div className="absolute -top-2 -right-2 bg-red-500 text-white rounded-full w-6 h-6 flex justify-center items-center text-base">
              {totalQuantity()}
            </div>
            ...
            ></FaShoppingCart>
            <div className="hidden absolute mt-12 shadow-md" ref={DropRef}>
