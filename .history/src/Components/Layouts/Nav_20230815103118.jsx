...
import { setCartItems, totalQuantiy } from "../../redux-toolkit/CartSlice";
...
const Nav = () => {
  ...
  const loadData = async (user, token) => {
    ...
    dispatch(setCartItems({ CartItems: res.data?.ListCart || [] }));
  };
