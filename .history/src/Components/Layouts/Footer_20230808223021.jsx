...
const ArrFollow = [
  {
    ...
    link: "#",
    icon: (
      <FaFacebook className="inline-block text-2xl font-semibold"></FaFacebook>
    ),
  },
  {
    title: "Instagram",
    link: "#",
    icon: (
      <FaInstagram className="inline-block text-2xl font-semibold"></FaInstagram>
    ),
  },
  {
    title: "Twitter",
    link: "#",
    icon: (
      <FaTwitter className="inline-block text-2xl font-semibold"></FaTwitter>
    ),
  },
  {
    title: "Youtube",
    link: "#",
    icon: (
      <FaYoutube className="inline-block text-2xl font-semibold"></FaYoutube>
    ),
  },
];
