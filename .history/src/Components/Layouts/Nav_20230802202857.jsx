    ...
    <>
      <div className="shadow-md mb-2 px-[10%] ">
        ...
        <div className="mb-2 pb-4 flex">
          ...
          <div
            className="flex justify-end ml-auto text- text-green-500 self-center hover:text-green-600 cursor-pointer transition-all relative"
            onMouseOver={() => {
          ...
          >
            ...
            ></FaShoppingCart>
            <div
              className="hidden absolute mt-14 translate-x-2 shadow-md"
              ref={DropRef}
            >
