      ...
      <div className="shadow-md mb-2 px-[10%]">
        ...
        <div className="mb-2 pb-4 flex">
          ...
          >
            ...
            />
            <button className="py-2 rounded-md px-3 border-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent bg-green-500 text-white  hover:bg-green-600 absolute right-full">
              Search
            </button>
          </form>
        </div>
