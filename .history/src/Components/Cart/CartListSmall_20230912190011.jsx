...
const CartListSmall = () => {
  ...
  return (
    <div>
      ...
      {listTemp?.length > 0 && (
        <div
          className="text-black flex flex-col font-semibold text-base min-w-max gap-2 bg-gray-100 px-3 py-2 border rounded-md"
          onClick={() => {
            navigate(`/product/${listTemp[0]?.product._id}`);
          }}
        >
