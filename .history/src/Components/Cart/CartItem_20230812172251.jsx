      ...
      {error && (
        ...
        >
          ...
          >
            ...
            <button
              id="closeButton"
              className="absolute w-5 h-5 rounded-full bg-red-400 -top-3 -right-3 text-white flex items-center justify-center hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent"
              onClick={() => {
