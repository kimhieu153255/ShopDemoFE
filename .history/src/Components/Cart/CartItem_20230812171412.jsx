...
const CartItem = ({
  ...
  return (
    <div className="min-w-max flex justify-around items-center gap-3 w-full m-auto py-2 px-4 hover:bg-gray-50 border rounded-lg">
      ...
      <div
        id="overlay"
        className="fixed top-0 left-0 w-full h-full bg-opacity-70 items-center justify-center"
        ref={overlayRef}
      >
        <div
          id="messageBox"
          className="bg-white m-auto self-center w-80 h-28 overflow-hidden p-4 rounded-md relative"
        >
