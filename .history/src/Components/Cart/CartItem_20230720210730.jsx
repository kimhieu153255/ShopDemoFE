          ...
          <div className="font-semibold">
            ...
            {color &&
              ...
              color.map((item) => (
                <div
                  key={item}
                  className="inline-block border-2 px-2 py-1 rounded-md font-normal hover:border-green-500 hover:text-green-500"
                >
                  {item}
                </div>
              ))}
            ...
            <div className="font-semibold">
              size:
              {
                ...
                size.map((item) => (
                  <div
                    key={item}
                    className="inline-block border px-2 py-1 rounded-md font-normal hover:border-green-500 hover:text-green-500"
                  >
                    {item}
                  </div>
                ))
