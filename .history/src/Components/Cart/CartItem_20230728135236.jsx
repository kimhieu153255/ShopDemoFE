...
const CartItem = ({ img, color, size, price, name, check, id, num }) => {
  ...
  // check && buyProduct(check, id, colorChosen, sizeChosen, num, price);
  const funcRef = useRef();
  funcRef.current = buyProduct;
  useEffect(() => {
    funcRef.current(check, id, colorChosen, sizeChosen, num, price);
  }, [check, colorChosen, id, num, price, sizeChosen]);
  return (
