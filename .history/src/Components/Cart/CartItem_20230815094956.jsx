...
const CartItem = ({ img, price, name, check, id, color, size, num }) => {
  ...
  const [colorChosen, setColorChosen] = useState(color || "");
  const [sizeColor, setSizeColor] = useState({});
  const [currentSize, setCurrentSize] = useState();
  const [currentColor, setCurrentColor] = useState();
  const [sizeChosen, setSizeChosen] = useState(size || "");
      ...
      <button
        ...
        onClick={() => {
          ...
          dispatch(
            removeCart({
              id,
              color: colorChosen ? colorChosen : null,
              size: sizeChosen ? sizeChosen : null,
            })
          );
        }}
      >
