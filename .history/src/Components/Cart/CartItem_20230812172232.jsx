...
import { FaCaretDown, FaMinus, FaPlus, FaTimes } from "react-icons/fa";
    ...
    <div className="min-w-max flex justify-around items-center gap-3 w-full m-auto py-2 px-4 hover:bg-gray-50 border rounded-lg">
      ...
      {error && (
        ...
        >
          <div
            id="messageBox"
            className="bg-white m-auto w-80 h-28 overflow-hidden p-4 rounded-md relative"
          >
            <p className="mb-4 font-semibold">{error}</p>
            <button
              id="closeButton"
              className="absolute w-6 h-6 rounded-full bg-red-400 -top-3 -right-3 text-white flex items-center justify-center hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent z-10"
              onClick={() => {
