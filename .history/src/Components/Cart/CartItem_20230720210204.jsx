...
const CartItem = ({ img, color, size, price, name }) => {
  ...
  return (
    <div className="min-w-max flex justify-around items-center gap-3 w-4/5 m-auto py-2 px-4 hover:bg-gray-50 border rounded-lg shadow-sm">
      ...
      >
        ...
        <div
          className="hidden absolute bg-gray-100 p-2 border rounded-md"
          ref={DropRef}
        >
