...
const CartList = () => {
  ...
  return (
    <div className="flex flex-col gap-2 p-5 min-w-max">
      {list.length === 0 && (
        <div className="text-center h-80 items-center">
          <div className="font-bold text-gray-400 inline-block self-center">
            <FaShoppingBasket className="inline-block"></FaShoppingBasket>
          </div>
        </div>
      )}
      {list.map((item, index) => (
