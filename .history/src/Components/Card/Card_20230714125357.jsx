...
const Card = ({ imgSrc, title, events, cost, num }) => {
  return (
    <div className="inline-block w-44 bg-gray-200 shadow-md hover:border hover:border-green-500 hover:ring-green-300 hover:outline-none rounded-lg cursor-pointer">
