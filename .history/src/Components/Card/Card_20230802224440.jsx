...
const Card = ({ imgSrc, title, events, cost, num, rate }) => {
  ...
  return (
    <div className="inline-block w-44 bg-gray-200 shadow-md hover:border hover:border-green-500 hover:ring-green-500 hover:outline-none rounded-lg cursor-pointer hover:scale-105">
      <div
        className="rounded-lg h-48 m-1"
        onMouseOver={() => displayRef.current.class}
      >
        <img
      ...
      <div className="hidden" ref={displayRef}>
        <button className="w-full bg-green-500 text-white font-semibold py-2 rounded-b-lg hover:bg-green-600">
          Add to cart
        </button>
      </div>
    </div>
