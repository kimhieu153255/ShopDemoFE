...
const Card = ({ imgSrc, title, events, cost, num, rate }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="hidden absolute w-full z-10 border border-green-500 rounded-b-lg ring-1 ring-green-500 transition-all duration-300"
        ref={displayRef}
      >
        <button className="w-full bg-green-500 text-white font-semibold py-1 rounded-lg rounded-t-none hover:bg-green-600">
          Add to cart
        </button>
      </div>
    </div>
