...
const Card = ({ imgSrc, title, events, cost, num, rate }) => {
  ...
  return (
    <div
      className="inline-block w-44 bg-gray-200 shadow-md hover:border hover:border-green-500 hover:ring-green-500 hover:outline-none rounded-lg cursor-pointer hover:scale-105 hover:border-b-0"
