...
const CardList = () => {
  ...
  // setTotal(data?.totalPage);// lỗi ở đây
  //fix lỗi Cannot update a component (`PageProvider`) while rendering a different component (`CardList`). To locate the bad setState() call inside `CardList`

  //fix: https://stackoverflow.com/questions/62599858/cannot-update-a-component-while-rendering-a-different-component
