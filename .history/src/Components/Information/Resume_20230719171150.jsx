...
const Resume = () => {
  ...
  return (
    <div className="flex flex-col min-w-max p-2 bg-gray-50 border rounded-lg h-full gap-2">
      ...
      {userRef.current && (
        <div className="my-5 flex">
          <form
            ...
            className="flex flex-col gap-3 min-w-max border-0 border-r-2 border-gray-300 pl-5 w-full"
          >
            <div className="p-1.5">
          ...
          <div className="ml-5 w-2/5 flex flex-col justify-center items-center gap-2">
