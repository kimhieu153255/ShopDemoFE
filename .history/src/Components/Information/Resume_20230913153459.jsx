    ...
    <div className="flex flex-col min-w-max p-2 shadow-md bg-gray-50 border rounded-lg h-full">
      ...
      {user && (
        <form className="m-5 flex flex-col gap-2" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="border border-green-200 p-1.5 px-3 mx-auto rounded-md bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent text-white font-semibold "
          >
            Save
          </button>
        </form>
