    ...
    <div className="w-1/2 mx-auto bg-gray-100 p-5 border rounded-lg shadow-md">
      ...
      <form className="flex flex-col gap-2">
        ...
        <div className="px-1.5 w-40">
          <button
            type="submit"
            className="w-full bg-green-500 p-1.5 rounded-md border border-green-500 text-white hover:bg-white hover:text-green-500 hover:border-green-500 transition-all duration-300"
          >
            Change
          </button>
        </div>
