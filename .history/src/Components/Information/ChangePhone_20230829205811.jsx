const ChangePhone = () => {
  return (
    <div className="flex flex-col justify-center bg-gray-100 border rounded-md w-2/3 mx-auto">
      <h2 className="font-bold text-xl text-center">Change Phone Number</h2>
