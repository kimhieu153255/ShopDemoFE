...
const Resume = () => {
  ...
  return (
    <div className="flex flex-col min-w-max p-2 bg-gray-50 border rounded-lg h-full mx-10">
      ...
      {userRef.current && (
        <div className="my-5 flex gap-2">
          ...
          <div className="ml-5 w-2/5 m flex flex-col justify-center items-center gap-2 border-l-2 border-gray-300 px-5">
