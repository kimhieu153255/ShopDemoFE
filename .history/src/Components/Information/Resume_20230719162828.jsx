    ...
    <div className="flex flex-col min-w-max p-5 bg-gray-50 border rounded-lg h-full">
      ...
      {userRef.current && (
        <div className="my-5 flex">
          ...
          >
            <div className="p-1.5">
              <div className="font-semibold w-32 mr-5 inline-block text-right">
                Username:
              </div>
              <span>{userRef.current?.username || "username"}</span>
            </div>
            <div className="p-1.5">
              <span className="font-semibold w-32 sm:w-12 mr-5 inline-block text-right">
                Name:
              </span>
              <input
                type="text"
            ...
            <div className="p-1.5">
              <label
                htmlFor="gender"
                className="font-semibold w-32 mr-5 inline-block text-right"
              >
                Gender:
              </label>
              <select
