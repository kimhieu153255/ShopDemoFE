const ChangePhone = () => {
  return (
    <div className="flex flex-col gap-3 justify-center bg-gray-100 border rounded-md mx-auto">
      <h2 className="font-bold text-xl text-center my-5">
        Change Phone Number
      </h2>
      <div className="flex flex-col justify-center w-2/3 mx-auto gap-3 text-lg my-5">
