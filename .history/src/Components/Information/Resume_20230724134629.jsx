    ...
    <div className="flex flex-col min-w-max p-2 shadow-md bg-gray-50 border rounded-lg h-full mx-10">
      ...
      {userRef.current && (
        <div className="my-5 flex gap-2 mx-5">
          ...
          <div
            id="overlay"
            className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-70 items-center justify-center hidden" ref={overlayRef}
          >
            <div id="messageBox" className="bg-white p-4 rounded-md">
              <p className="mb-4">This is a message!</p>
              <button
                id="closeButton"
