    ...
    <div className="flex flex-col min-w-max p-2 shadow-md bg-gray-50 border rounded-lg h-full mx-10">
      ...
      {userRef.current && (
        <div className="my-5 flex gap-2 mx-5">
          ...
          <div
            id="overlay"
            class="fixed top-0 left-0 w-full h-full bg-black bg-opacity-70 flex items-center justify-center hidden"
          >
            <div id="messageBox" class="bg-white p-4 rounded-md">
              <p class="mb-4">This is a message!</p>
              <button
                id="closeButton"
