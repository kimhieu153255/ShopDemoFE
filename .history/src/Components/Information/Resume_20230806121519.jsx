        ...
        <div className="my-5 flex gap-2 mx-5">
          ...
          >
            <div id="messageBox" className="bg-white p-4 rounded-md relative">
              ...
              <button
                id="closeButton"
                className="absolute w-8 h-8 rounded-full bg-red-400 top-0 right-0 text-white flex items-center justify-center hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent"
              >
                x
              </button>
            </div>
