...
const OrderItem = ({ item }) => {
  ...
  return (
    <div className="box bg-gray-100 border rounded-md p-5 mb-2">
      ...
      <div className="flex justify-between pt-10 pb-5 gap-5 pr-2 text-lg">
        <button className="border border-green-500 rounded-md px-2 hover:bg-green-500 hover:border-green-600">
          Refund
        </button>
