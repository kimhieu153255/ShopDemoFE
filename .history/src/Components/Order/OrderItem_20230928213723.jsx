  ...
  return (
    <div className="box bg-gray-100 border rounded-md p-5 mb-2">
      ...
      {item?.productOrderArr?.map((product, ind) => (
        <div
          className="item flex items-center gap-5 justify-between mb-2 pl-2 pr-2 border-b-2 py-5 cursor-pointer hover:bg-green-500 hover:text-white"
          key={ind}
          onClick={() => {
      ...
      <div className="flex justify-end pt-10 pb-5 gap-5 pr-2 text-lg">
