...
function CartProvider(props) {
  ...
  function buyProduct(ischeck, id, color, size, quantity, price) {
    let product = {};
    if (ischeck) setBuyList([...buyList, { id, color, size, quantity, price }]);
    else setBuyList(buyList.filter((e) => e.id !== id));
