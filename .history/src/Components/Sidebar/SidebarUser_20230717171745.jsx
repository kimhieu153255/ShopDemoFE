        ...
        arrSidebar.map((item) => (
          <div key={item.title}>
            <div className="flex items-center gap-2">
              {item.icon === "user" && (
                <FaUserAlt className="text-green-500"></FaUserAlt>
              )}
              {item.icon === "cart" && (
                <FaShoppingCart className="text-green-500"></FaShoppingCart>
              )}
              {item.icon === "bell" && (
                <FaBell className="text-green-500"></FaBell>
              )}
              {item.icon === "gift" && (
                <FaTicketAlt className="text-green-500"></FaTicketAlt>
              )}
              {item.icon === "coin" && (
                <FaBitcoin className="text-green-500"></FaBitcoin>
              )}
              <div
