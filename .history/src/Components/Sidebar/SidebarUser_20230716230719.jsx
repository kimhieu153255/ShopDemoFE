...
const arrSidebar = [
  {
    title: "My account",
    content: [
      { title: "Résemé", path: "/user/information" },
      { title: "Address", path: "/user/information" },
      { title: "Change password", path: "/user/information" },
      { title: "Setting notification", path: "/user/information" },
    ],
  },
  {
    title: "My order",
