        ...
        arrSidebar.map((item) => (
          <div key={item.title}>
            <div className="flex items-center gap-2">
              {item.icon === "user" && (
                <FaUserAlt className="text-green-700"></FaUserAlt>
              )}
              {item.icon === "cart" && (
                <FaShoppingCart className="text-green-700"></FaShoppingCart>
              )}
              {item.icon === "bell" && (
                <FaBell className="text-green-700"></FaBell>
              )}
              {item.icon === "gift" && (
                <FaTicketAlt className="text-green-700"></FaTicketAlt>
              )}
              {item.icon === "coin" && (
                <FaBitcoin className="text-green-700"></FaBitcoin>
              )}
              <div
