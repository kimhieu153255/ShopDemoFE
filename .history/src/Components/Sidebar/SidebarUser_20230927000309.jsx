...
const SidebarUser = ({ username, avatar }) => {
  ...
  return (
    <div className="flex flex-col w-1/5 bg-gray-100 pl-3 pr-2 py-5 sm:pl-10 gap-3 text-lg min-w-max rounded-md border my-5">
        ...
        arrSidebar.map((item) => (
          <div key={item.title}>
            <div
              ...
              {...(item.icon === "cart" && {onClick: () => setIsDropdown(false)})}
            >
