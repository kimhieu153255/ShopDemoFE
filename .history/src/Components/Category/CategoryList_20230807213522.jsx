  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={`text-center absolute right-0 top-1/2 z-10 bg-white rounded-full shadow-lg hover:scale-110 transform transition-all duration-300 ease-in-out ${
          swiperRef.current?.isEnd ? "hidden" : ""
        }`}
      >
