...
const AddAddress = () => {
  ...
  return (
    <div className="relative bg-gray-100 p-5 rounded-md">
      ...
      ></input>
      <span
        className="absolute right-1 top-1 bg-gray-100 border translate-x-1/2 -translate-y-1/2 w-fit h-fit p-1
      rounded-full border-gray-400 hover:bg-green-500 hover:text-black text-gray-400"
      >
        <FaTimes />
      </span>
    </div>
