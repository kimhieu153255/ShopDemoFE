        ...
        <div className="relative bg-gray-100 p-5 rounded-md">
          ...
          <div className="flex gap-2 ">
            <div className="flex flex-col gap-2 w-full">
              <label htmlFor="fullname" className="font-semibold text-lg ml-1">
                Fullname
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col gap-2 w-full">
              <label htmlFor="phone" className="font-semibold text-lg ml-1">
                Phone number
              </label>
              <input
                type="text"
          ...
          <div className="my-3">
            <div className="font-semibold text-lg ml-2 mb-2">Address</div>
            <AddressInput
