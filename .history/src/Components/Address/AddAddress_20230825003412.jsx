...
const AddAddress = ({ isHidden, setIsHidden }) => {
  ...
  return (
    <div className={isHidden === true ? "hidden" : ""}>
      ...
      >
        <div
          className="absolute bg-gray-100 p-5 rounded-md items-center"
          ref={formRef}
        >
          ...
          <button className="px-6 py-1.5 bg-green-500 hover:bg-green-600 text-white rounded-md border transition-all">
            Add
          </button>
