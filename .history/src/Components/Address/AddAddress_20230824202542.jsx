...
const AddAddress = ({ isHidden, setIsHidden }) => {
  ...
  return (
    <div className={isHidden === true ? "hidden" : ""}>
      <div className="fixed inset-0 top-0 z-10 left-0  bg-gray-500 opacity-50"></div>
      <div className="fixed w-full h-screen top-0 z-10 left-0 flex justify-center items-center">
